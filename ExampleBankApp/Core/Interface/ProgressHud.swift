...
public extension ProgressHUD {
    ...
    //-------------------------------------------------------------------------------------------------------------------------------------------
    @discardableResult
    class func show(_ status: String? = nil,
                    interaction: Bool = true,
                    color: UIColor, background: UIColor) -> ProgressHUD {
...
public class ProgressHUD: UIView {
    ...
    private var animationType    = ProgressAnimationType.circleRotateChase

    private var colorBackground    = UIColor.clear
    private var colorHUD        = UIColor.clear
    private var colorStatus        = UIColor.black//label
    ...
    private func setupBackground(_ interaction: Bool) {
        ...
        viewBackground?.isUserInteractionEnabled = (interaction == true)
    }
    ...
    private func setupToolbar() {
        ...
        if (toolbarHUD == nil) {
            ...
            toolbarHUD?.layer.cornerRadius = 16
    ...
    private func setupProgress(_ progress: CGFloat?) {
        ...
        if (viewProgress == nil) {
            ...
            viewProgress?.frame = CGRect(x: 0, y: 0, width: 64, height: 64)
        }
    ...
    private func setupAnimation() {
        ...
        if (viewAnimation == nil) {
            viewAnimation = UIView(frame: CGRect(x: 0, y: 0, width: 48, height: 48))
        }
    ...
    private func setupAnimatedIcon(_ animatedIcon: AnimatedIcon?) {
        ...
        if (viewAnimatedIcon == nil) {
            viewAnimatedIcon = UIView(frame: CGRect(x: 0, y: 0, width: 64, height: 64))
        }
    ...
    private func setupStaticImage(_ staticImage: UIImage?) {
        ...
        if (staticImageView == nil) {
            staticImageView = UIImageView(frame: CGRect(x: 0, y: 0, width: 54, height: 54))
        }
...
extension ProgressHUD {
    ...
    @discardableResult
    public static func start() -> ProgressHUD {
        ProgressHUD.show(.zero(),
                         color: .blue,
                         background: .blue)
    }
